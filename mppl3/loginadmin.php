...
<head>
    ...
    <title>Halaman login akun admin</title>
</head>
<body>
    <div class = "header">
    <div class="logo_bg"></div><div class="tulis">
        ...
        <ul class="links">
        <li>Kamu admin baru dan belum memiliki akun ?<a href = "registrationadmin.php">Daftar</a></li>
    ...
    if(isset($_POST['login'])){
        ...
        $result = mysqli_query($mysqli,"SELECT * FROM administrator WHERE username = '$username' and password = '$password';");
        
        if(mysqli_num_rows($result) == 1){
            echo "<p class='berhasil'>Login berhasil, silahkan verifikasi kode <a href='verif.php'> masuk</a></p>";
            ...
            header("Location: loginadmin.php?pesan=$pesan");
        }
